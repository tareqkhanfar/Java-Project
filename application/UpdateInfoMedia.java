...
public class UpdateInfoMedia extends GridPane {
	public UpdateInfoMedia() {
		setStyle("-fx-background-color:#D3FFAC;\r\n");
		...
		Update.setStyle("-fx-background-color:rgba(0,0,0,0);");
		...
		Update.setOnAction(e -> {
			...
			if (TtypeMedia.getText().equals("Album")) {

				info[0] = TtypeMedia.getText();
				info[1] = Tcode.getText();
				info[2] = Ttitle.getText();
				info[3] = TnumberOfCopies.getText();
				info[4] = Tartist.getText();
				info[5] = Tsong.getText();
				data.UpdateInfoMedia(info);
			} else if (TtypeMedia.getText().equals("Game")) {

				info[0] = TtypeMedia.getText();
				info[1] = Tcode.getText();
				info[2] = Ttitle.getText();
				info[3] = TnumberOfCopies.getText();
				info[4] = Tweigh.getText();
				data.UpdateInfoMedia(info);
